...
class_names = ['recharge seat','dust collecting barrel']
 
xmlpath='/home/numen/Desktop/yolov5-data/Annotations/' #原xml路径
txtpath='/home/numen/Desktop/yolov5-data/images/'     #转换后txt文件存放路径 
files = []
